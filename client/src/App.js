...
import UserProductReviews from "./BusinessDashboard/pages/UserProductReviews.js"
...
function App() {
  ...
  const UserProductReviewsHDC = LayoutUser(UserProductReviews)
      ...
      <ProSidebarProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/user/product/reviews" element={<UserProductReviewsHDC />} />
